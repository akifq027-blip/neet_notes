...
export function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900 font-sans antialiased selection:bg-emerald-500 selection:text-white max-w-full overflow-x-hidden">
      {/* Main Navbar */}
      <Navbar
        user={currentUser}
        cartCount={cartItems.length}
        wishlistCount={wishlistIds.length}
        announcement="🎉 Class 8–12 & NEET 2026: Use code NCERT20 for 20% OFF on all notes!"
      ...
      <main className="flex-1 pb-16 md:pb-0">
        ...
        {currentView === 'notes' && (
          <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-10 space-y-6 sm:space-y-8 w-full min-w-0">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
                ...
                <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 sm:gap-3 shrink-0">
                  {/* Sort Dropdown */}
                  <div className="flex items-center gap-1.5 bg-white px-2.5 sm:px-3 py-2 rounded-xl border border-slate-200 text-xs font-semibold">
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-xl border text-xs font-bold transition-colors cursor-pointer whitespace-nowrap ${
                      freeOnly
              ...
              {/* Class Selection Tabs - Horizontal scrolling */}
                ...
                <div className="flex items-center gap-1.5 sm:gap-2 min-w-max">
                  {['All', 'Class 8', 'Class 9', 'Class 10', 'Class 11', 'Class 12', 'NEET'].map((cls) => (
                    <button
                      ...
                      className={`px-3.5 sm:px-4 py-1.5 sm:py-2 rounded-xl text-xs font-black tracking-wide whitespace-nowrap transition-all cursor-pointer shrink-0 ${
                        selectedClass === cls
              ...
              {/* Sub-Filters: Subject & Resource Type (stacked on < sm, horizontal on >= sm) */}
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-3 rounded-2xl border border-slate-200 w-full max-w-full overflow-hidden">
                {/* Subject Pills */}
                ...
                <div className="flex flex-col xs:flex-row sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto shrink-0">
                  <select
                    ...
                    className="bg-slate-50 border border-slate-200 text-slate-700 text-xs font-bold rounded-lg px-2.5 py-1.5 outline-none cursor-pointer flex-1 sm:flex-none"
                  >
              ...
              <div className="relative w-full max-w-full">
                <input
                  ...
                  className="w-full box-border text-xs sm:text-sm pl-10 pr-4 py-2.5 sm:py-3 rounded-2xl bg-white border border-slate-200 shadow-xs focus:border-teal-500 focus:ring-1 focus:ring-teal-500 outline-none font-medium"
                />
