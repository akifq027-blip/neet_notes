  ...
  return (
    <header className="bg-teal-700 text-white relative overflow-hidden pt-12 pb-16 sm:pt-16 sm:pb-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-10">
          ...
          <div className="max-w-2xl space-y-5 text-left">
            ...
            <div className="pt-2 max-w-xl">
              <div className="relative flex items-center shadow-xl rounded-full bg-white text-slate-800 p-1.5 focus-within:ring-4 focus-within:ring-teal-400/30 transition-all">
                ...
                <button
                  ...
                  className="bg-slate-900 hover:bg-slate-800 text-white font-black text-xs uppercase tracking-wider px-5 py-2.5 rounded-full transition-all shrink-0 cursor-pointer"
                >
                  Search
                </button>
              </div>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-3">
              <button
                id="hero-explore-btn"
                onClick={() => onExplore()}
                className="bg-white text-teal-800 hover:bg-teal-50 px-6 py-3 rounded-xl font-black text-xs sm:text-sm uppercase tracking-wider shadow-lg transition-all flex items-center gap-2 cursor-pointer"
              >
        ...
        {/* Feature Strip */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mt-12 pt-8 border-t border-teal-600/60 text-xs font-bold">
